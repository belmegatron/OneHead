...
class OneHeadChannelsTest(TestCase):
    ...
    @patch("src.onehead_common.OneHeadChannels._get_discord_members")
    @patch("src.onehead_common.OneHeadChannels._get_names_from_teams", return_value=(MagicMock(), MagicMock()))
