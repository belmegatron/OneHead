...
class OneHeadDBTest(TestCase):
    def setUp(self):
        self.rt_response = {
            ...
            "ScannedCount": 20,
            "ResponseMetadata": {
                "RequestId": "OK50L9TCALP71OKO4T45TTEINNVV4KQNSO5AEMVJF66Q9ASUAAJG",
                "HTTPStatusCode": 200,
                "HTTPHeaders": {
                    "server": "Server",
        ...
        self.lp_response = {
            ...
            "ResponseMetadata": {
                "RequestId": "BJ5U2L36NDUFDBPIGR91J59NNFVV4KQNSO5AEMVJF66Q9ASUAAJG",
                "HTTPStatusCode": 200,
                "HTTPHeaders": {
                    "server": "Server",
                    "date": "Thu, 09 Apr 2020 21:46:29 GMT",
                    "content-type": "application/x-amz-json-1.0",
                    "content-length": "85",
                    "connection": "keep-alive",
                    "x-amzn-requestid": "BJ5U2L36NDUFDBPIGR91J59NNFVV4KQNSO5AEMVJF66Q9ASUAAJG",
                    "x-amz-crc32": "27472350",
                },
                "RetryAttempts": 0,
            },
        }
