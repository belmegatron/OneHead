...
class OneHeadStateTest(TestCase):
    ...
    def test_result_reset_state(self):
        ...
        team_balance.balance = OneHeadAsyncTest.async_mock(
            return_value=([{"name": "A"}, {"name": "B"}, {"name": "C"}, {"name": "D"}, {"name": "E"}],
        ...
        pregame = self.bot.get_cog("OneHeadPreGame")
        pregame.signups = ["RBEEZAY", "GEE", "LAURENCE", "ZEE", "EDD", "ERIC", "JAQ", "PECRO", "SPONGE", "TOCCO"]

        # Mock out how the teams were balanced
        team_balance = self.bot.get_cog("OneHeadBalance")
        team_balance.balance = OneHeadAsyncTest.async_mock(
            return_value=(
                [{"name": "RBEEZAY"}, {"name": "GEE"}, {"name": "LAURENCE"}, {"name": "ZEE"}, {"name": "EDD"}],
                [{"name": "ERIC"}, {"name": "JAQ"}, {"name": "PECRO"}, {"name": "SPONGE"}, {"name": "TOCCO"}]))
        ...
        self.assertEqual(core.t2,
                         [{"name": "ERIC"}, {"name": "JAQ"}, {"name": "PECRO"}, {"name": "SPONGE"}, {"name": "TOCCO"}])
        self.assertEqual(pregame.signups,
                         ["RBEEZAY", "GEE", "LAURENCE", "ZEE", "EDD", "ERIC", "JAQ", "PECRO", "SPONGE", "TOCCO"])
